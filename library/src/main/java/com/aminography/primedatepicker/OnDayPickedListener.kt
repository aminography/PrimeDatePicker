...
interface OnDayPickedListener {
     ...
     *
     * @param pickType Specifies type of the picked day based on [PickType] which is set to the [com.aminography.primedatepicker.monthview.PrimeMonthView] or [com.aminography.primedatepicker.calendarview.PrimeCalendarView].
