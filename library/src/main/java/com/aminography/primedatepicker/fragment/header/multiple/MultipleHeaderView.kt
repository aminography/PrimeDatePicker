...
import com.aminography.primedatepicker.fragment.header.multiple.adapter.PickedDaysListAdapter
...
class MultipleHeaderView(
    viewStub: ViewStub
) : BaseHeaderView(R.layout.multiple_days_header, viewStub) {
    ...
    private val multipleDaysAdapter: PickedDaysListAdapter by lazy {
        PickedDaysListAdapter().also {
            ...
            rootView.recyclerView.layoutManager = LinearLayoutManager(rootView.recyclerView.context, LinearLayoutManager.HORIZONTAL, false)
